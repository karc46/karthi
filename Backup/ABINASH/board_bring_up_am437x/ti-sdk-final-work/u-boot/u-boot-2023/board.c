...
#ifdef __PEARL_ETHERNET__
const struct emif_regs ddr3_emif_regs_400Mhz_pearl_ethernet = {
        .sdram_config                   = 0x61A04B32,
        .ref_ctrl                       = 0x00000C30,
        .sdram_tim1                     = 0xEAAAE518,
        .sdram_tim2                     = 0x266B7FDA,
        .sdram_tim3                     = 0x5F7F867F,
        .read_idle_ctrl                 = 0x00050000,
        .zq_config                      = 0x50077D33,
        .temp_alert_config              = 0x0,
        .emif_ddr_phy_ctlr_1            = 0x00048008, //0x0E004008,
...
const struct emif_regs ddr3_emif_regs_400Mhz_pearl_ethernet_vipinboard = {
...
void sdram_init(void)
{
        ...
        config_ddr(0, &ioregs_ddr3, NULL, NULL,
                &ddr3_emif_regs_400Mhz_pearl_ethernet, 0);
#else
	/*
