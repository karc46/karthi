...
//#define __EVK_DDR_WORKING_CUSTOM_BOARD__
#ifdef __EVK_DDR_WORKING_CUSTOM_BOARD__
...
const struct emif_regs ddr3_emif_regs_400Mhz = {
	/* Working with Customer config */
        .sdram_config                   = 0x61A05332,//ok
        .ref_ctrl                       = 0x00000C30,//Nill
        .sdram_tim1                     = 0xEAAAE51B,//ok
        .sdram_tim2                     = 0x266B7FDA,//ok
        .sdram_tim3                     = 0x5F7F867F,//ok
        .read_idle_ctrl                 = 0x00050000,//Nill
        .zq_config                      = 0x50074BE4,//Nill
       	.temp_alert_config              = 0x0,//ok


	.emif_ddr_phy_ctlr_1            = 0x0E004008,
        .emif_ddr_ext_phy_ctrl_1        = 0x00040100,   //0x08020080,
        .emif_ddr_ext_phy_ctrl_2        = 0x00,
        .emif_ddr_ext_phy_ctrl_3        = 0x00,
        .emif_ddr_ext_phy_ctrl_4        = 0x00,
        .emif_ddr_ext_phy_ctrl_5        = 0x00,
/*
        .emif_ddr_phy_ctlr_1            = 0x00048009,//ok
        .emif_ddr_ext_phy_ctrl_1        = 0x00040100,//ok
        .emif_ddr_ext_phy_ctrl_2        = 0x00000000,//ok
        .emif_ddr_ext_phy_ctrl_3        = 0x00000000,//ok
        .emif_ddr_ext_phy_ctrl_4        = 0x00000000,//ok
        .emif_ddr_ext_phy_ctrl_5        = 0x00000000,//ok
*/
...
const struct emif_regs ddr3_emif_regs_400Mhz = {
        ...
        .emif_ddr_ext_phy_ctrl_4        = 0x00000000,//ok
        .emif_ddr_ext_phy_ctrl_5        = 0x00000000,//ok
        .emif_rd_wr_lvl_rmp_win         = 0x00000000,//ok
        .emif_rd_wr_lvl_rmp_ctl         = 0x80000000,//ok
        .emif_rd_wr_lvl_ctl             = 0x00000000,//ok
        .emif_rd_wr_exec_thresh         = 0x80000405,//Nill
        .emif_prio_class_serv_map       = 0x80000001,//Nill
        .emif_connect_id_serv_1_map     = 0x80000094,//Nill
        .emif_connect_id_serv_2_map     = 0x00000000,//Nill
        .emif_cos_config                = 0x000FFFFF//Nill
};
